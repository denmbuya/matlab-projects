/*
 * File: computeSpectrumMetrics_emxAPI.c
 *
...
/* Include Files */
#include "computeSpectrumMetrics_emxAPI.h"
...
/*
 * File trailer for computeSpectrumMetrics_emxAPI.c
 *
 * [EOF]
 */
